...
namespace PersistentPlanet.DualContouring
{
    public class QefSolver
    {
        ...
        public void add(float px, float py, float pz, float nx, float ny, float nz)
        {
            ...
            Vector3 tmpv = Vector3.Normalize(new Vector3(nx, ny, nz));
        ...
        public float solve(Vector3 outx, float svd_tol, int svd_sweeps, float pinv_tol)
        {
            ...
            massPoint = new Vector3(data.massPoint_x, data.massPoint_y, data.massPoint_z);
        ...
        private void setAtb()
        {
            atb = new Vector3(data.atb_x, data.atb_y, data.atb_z);
        }
